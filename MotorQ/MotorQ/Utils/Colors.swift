...
extension Color{
    ...
    public static let accentPurple : LinearGradient = LinearGradient(gradient: Gradient(colors: [Color(red: (84/255), green: (92/255), blue: (255/255),opacity: 1), Color(red: (77/255), green: (89/255), blue: (213/255),opacity: 1)]), startPoint: /*@START_MENU_TOKEN@*/.leading/*@END_MENU_TOKEN@*/, endPoint: /*@START_MENU_TOKEN@*/.trailing/*@END_MENU_TOKEN@*/)
